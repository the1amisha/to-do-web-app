...
import { createTask, findTask, findTaskIndex, addTask, deleteTask, toggleTask, editTask } from '../js/tasks.js';
...
describe('findTask', () => {
  ...
  it('returns the first match when ids are duplicated', () => {
    const dup = [makeTask({ id: 'x', title: 'Original' }), makeTask({ id: 'x', title: 'Duplicate' })];
...
describe('editTask', () => {
  ...
  it('applies multiple updates at once', () => {
    ...
    editTask(tasks, 'a', { title: 'Updated', dueDate: '2026-07-20', listId: 'work' });
